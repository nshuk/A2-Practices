...
class Company:
    def __init__(self):
        self.__companyName = ""
        self.__emailAddress = ""
        self.__dateLastContact = datetime.date(2000, 1, 1)

    def SetCompanyName(self, n):
        self.__companyName = n
    def SetEmailAddress(self, e):
        self.__emailAddress = e
    def SetDateLastContact(self):
...
myCompany.SetCompanyName("MARA")
myCompany.SetEmailAddress("naqib@gmail.com")
